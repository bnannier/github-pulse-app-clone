...
-- Create a function to trigger repository syncing
...
-- Schedule the sync function to run every 30 minutes
SELECT cron.schedule(
  'sync-repositories-every-30min',
  '*/30 * * * *', -- Every 30 minutes
  $$SELECT public.sync_all_repositories();$$
);